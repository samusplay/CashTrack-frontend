...
//La funcion recibe normalemnte un objeto grande Props
//Destructuramos es paquete Grande {user}

//La segunda partees el type osea el tipo de dato ya que estamos usando TypeScript
